    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // create new task
                final RecipeSearchAsyncTask task = new RecipeSearchAsyncTask();
                //create a listner and add it to the task
                task.setRecipeListener(new RecipeSearchAsyncTask.RecipeListener() {

                    @Override
                    public void RecipeModeltoListener(List<RecipeModel> recipe) {
                        //show the first response on the screen
                        RecipeModel first = recipe.get(0);
