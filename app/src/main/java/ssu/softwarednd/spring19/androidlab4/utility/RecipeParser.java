...
public class RecipeParser {
    ...
    public static List<RecipeModel> getMatches(String json) {
        ...
        try {
            ...
            String recipeName = firstMatch.getString("recipeName");
            int recipeRating = firstMatch.getInt("rating");
            RecipeModel ReceivedRecipe = new RecipeModel();
            ReceivedRecipe.setRecipeName(recipeName);
            ReceivedRecipe.setRecipeRating(recipeRating);
            modelList.add(ReceivedRecipe);
